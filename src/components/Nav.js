...
export default function Nav() {
  ...
  return (
    <div className="py-6 md:py-8 flex flex-row justify-between items-center h-full w-full top-0 sticky">
      ...
      <div className="w-auto flex flex-row items-center justify-end">
        ...
        <div
          className={
            open
              ? "bg-darkgrey bg-[url('../assets/stars_black.svg')] text-mainbg fixed right-0 top-0 w-full min-h-screen flex flex-col justify-between px-4 md:px-12 lg:px-24 pb-10 z-50 transition ease-in-out duration-500 delay-500"
              : "hidden"
          }
        >
          <div className="py-6 md:py-8 flex flex-row items-center justify-between">
            <div className="flex flex-row items-center gap-2 lg:gap-8 uppercase font-semibold">
              <Link to="/home">
                <img
                  src={profileLight}
                  alt="profile"
          ...
          <div className="flex flex-col justify-between items-end w-full">
            ...
            <div className="hidden md:flex flex-row justify-between items-end pb-4 w-full">
              <div className="flex w-1/3 lg:w-1/4">
                <p className="text-sm">
                  The world of digital design and web development has grown at
                  an extremely rapid rate over the last 10 years and my aim has
                  been to evolve with it. I’m learning and gaining new skills
                  every day.
                </p>
              </div>
